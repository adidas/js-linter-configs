module.exports = {
  ...
  rules: {
    ...
    'vue/html-self-closing': [ 'error', { html: { void: 'always', normal: 'never', component: 'always' }, svg: 'any', math: 'any' }],
    'vue/html-quotes': [ 'error', 'double' ],
    'vue/jsx-uses-vars': 'error',
    'vue/max-attributes-per-line': [ 'error', { singleline: Infinity, multiline: { max: 1, allowFirstLine: true } }],
